...
Feature: Checkout-Payment Methods Screen
  ...
  @TC_01-Checkout-PaymentMethodsScreen
  Scenario Outline: Verify the Checkout/Payment Methods Screen
  ...
  @TC_02-Checkout-PaymentMethodsScreen
  Scenario Outline:Verify the Anonymous User At the Checkout/Payment Methods Screen
    Given User is on Membership tee time landing page
    Then User click on Course Policies Done button
    Then Navigate to Tee Time Screen is displayed
    Then User Select Course
